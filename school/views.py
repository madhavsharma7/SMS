...
def admin_teacher_view(request):
    ...
    return render(request,'school/admin_teacher.html',context)
...
def admin_student_view(request):
    ...
    context={
        'studentcount':studentcount,
        'pendingstudent':pendingstudentcount,
        'studentfee':studentfee['fee__sum'],
    }
    return render(request,'school/admin_student.html',context=context)
